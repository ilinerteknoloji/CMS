...
class ModelCustomer extends BaseModel
{
    public function createCustomer($data)
    {
        ...
        $insert = $user->execute([$customer_name,$customer_surname,$customer_email,$customer_phone,$customer_gsm,$customer_address,$customer_company]);
    ...
    public function editCustomer($data)
    {
        ...
        $update = $user->execute([$customer_name,$customer_surname,$customer_email,$customer_phone,$customer_gsm,$customer_address,$customer_company,$customer_id]);
