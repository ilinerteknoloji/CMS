...
class ModelProject extends BaseModel
{
    public function createProject($data)
    {
        ...
        $insert = $user->execute([$customer_id,$title,$description,$start_date,$end_date,intval(Session::getSession('id')),$progress,$status]);
    ...
    public function editProject($data)
    {
        ...
        $update = $user->execute([intval($customer_id),$title,$description,$start_date,$end_date,intval(Session::getSession('id')),$progress,$status,$id]);
